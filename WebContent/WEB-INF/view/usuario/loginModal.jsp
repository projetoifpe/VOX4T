...
>>>>>>> refs/remotes/origin/Henrique
	...
	<center>
		<button class="btn btn-primary" data-toggle="modal"
			data-target="#modal-mensagem">Login</button>
	</center>
				...
				<div class="login-form">
					<form action="/examples/actions/confirmation.php" method="post"
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="email" class="form-control" name="email" id="email"
									class="required" placeholder="Email">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="password" class="form-control" name="senha"
									id="senha" class="required" placeholder="Senha">
							</div>
						</div>
						...
						<div class="text-center social-btn">
							<a href="#" class="btn btn-primary" id="login"><i
								class="fab fa-facebook-square"></i>&nbsp; Facebook</a> <a href="#"
								class="btn btn-danger"><i class="fab fa-google-plus-g"></i>&nbsp;
								Google</a>
						</div>
					</form>

					<p class="text-center text-muted small">
						Vocẽ não tem uma conta? <a href="cadastro">Cadastre-se aqui!</a>
					</p>
